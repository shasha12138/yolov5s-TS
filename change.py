...
parser.add_argument('--json_path', default='datasets/ESOGU-APPLES/annotations/instances_train.json', type=str,
                    help="input: coco format(json)")
parser.add_argument('--save_path', default='datasets/ESOGU-APPLES/labels/train', type=str,
